...
import IAddress from "../../app/types/IAddress";
...
export const { addAddress, removeAddress, emptyAddresses, setSelectedAddress } = addressSlice.actions;
export const selectAddress = (state: RootState) => state.address.addresses.values;
